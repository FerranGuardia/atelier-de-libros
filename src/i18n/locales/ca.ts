...
const dict: PartialDictionary = {
  ...
  meta: {
    ...
    publishers: {
      ...
      description:
        'Per a segells editorials: els vostres llibres als espais on neix la tendència.'
    },
    historias: {
  ...
  publishers: {
    ...
    headline: 'Els vostres llibres als espais on neix la tendència.',
    cta: 'Sol·licitar dossier'
  },
